...
public class TermRangeQueryTool {
    public static TopDocs search(String field, String low,String high,boolean includeLow,boolean includeHigh, String readPath, int fetchSize) throws Exception {
        ...
        for (ScoreDoc scoreDoc : hits.scoreDocs) {
            ...
            System.out.println(document.get("center") + " : "+document.get("address"));
        }
        reader.close();
        return hits;
    }
    ...
    public static void main(String[] args) {
        try {
            TermRangeQueryTool.search("facility","F","y",true,true,"D:\\Index\\out\\science\\",10);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
